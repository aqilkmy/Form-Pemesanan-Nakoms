...
insert into pj_mappings (category, lookup_key, nama, nomor) values
  ...
  ('desain_grafis', 'Kementerian Advokasi dan Kesejahteraan Mahasiswa', 'Kynaa', '6289526269980'),
...
insert into pj_mappings (category, lookup_key, nama, nomor) values
  ...
  ('website', 'Kementerian Advokasi dan Kesejahteraan Mahasiswa', 'Bintang', '6285710205061'),
