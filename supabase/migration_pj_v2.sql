...
insert into pj_mappings (category, lookup_key, pj_id, platforms) values
  ...
  ('desain_grafis', 'Kementerian Advokasi Kesejahteraan Mahasiswa', (select id from inserted_pjs where nama = 'Kynaa'), null),
  ...
  ('website', 'Kementerian Advokasi Kesejahteraan Mahasiswa', (select id from inserted_pjs where nama = 'Bintang'), null),
